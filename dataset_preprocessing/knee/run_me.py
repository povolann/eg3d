...
if __name__ == '__main__':
    with tempfile.TemporaryDirectory() as working_dir:
        output_dataset_name = 'knee_128.zip'

        dir_path = os.path.dirname(os.path.realpath(__file__))
        data_path = '/home/anya/Programs/eg3d/dataset_preprocessing/knee/knee2/'

        print("Converting camera parameters...")
        cmd = f"python {os.path.join(dir_path, 'preprocess_knee_cameras.py')} --source={data_path}"
