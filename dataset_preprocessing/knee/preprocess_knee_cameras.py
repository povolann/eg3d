...
if __name__ == '__main__':
    parser = argparse.ArgumentParser() # /home/anya/Downloads/cars_train/
    parser.add_argument("--source", type=str, default='/home/anya/Downloads/cars_train/') #/home/anya/Programs/eg3d/dataset_preprocessing/knee/knee/
    ...
    for scene_folder_path in list_recursive(dataset_path):
        ...
        for rgb_path in list_recursive(os.path.join(scene_folder_path, 'rgb')):
            ...
            with open(pose_path, 'r') as f:
                ...
                #pose = np.array([float(n.replace('\n', ' ')) for n in f.read().split(' ')]).reshape(4, 4).tolist()
            ...
            with open(intrinsics_path, 'r') as f:
                ...
                orig_img_size = 128  # cars_train has intrinsics corresponding to image size of 512 * 512
                intrinsics = np.array(
